...
?>
    ...
    <main class="contenedor seccion">
        ...
        <a href="/bienes/admin/vendedores/crear.php" class="boton boton-amarillo">Nuevo Vendedor</a>
        ...
        <table class="propiedades">
            ...
            <tbody> <!-- Mostrar los Resultados -->
                ...
                <tr>
                    ...
                    <td> <img src="/bienes/imagenes/<?php echo $propiedad->imagen; ?>" class="imagen-tabla"> </td>
